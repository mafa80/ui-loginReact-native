...
import { Icon, Button, SocialIcon,Tile  } from 'react-native-elements'
      ...
      <ImageBackground source={imgbg} style={{ width: '100%', height: '100%' }}>
        ...
        <View style={styles.container}>
          ...
          <View style={styles.containerRegister}> 
              <Text style={{color:'white',fontWeight: 'bold'}}>Realizar Test
                <Text
                style={{color:'red',fontWeight: 'bold',}}>  Aqui</Text>
              </Text>
            </View>
